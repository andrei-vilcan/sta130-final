...
\tiny From the bar graph below, we can clearly identify that B&E offences occur the most often in high-risk neighborhoods. 
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.width=4.5, fig.height=0.5}
sim_q3 %>% 
