...
\tiny Our main research question was as follows: " In neightboorhoods with high B&E  rates, what are the commonalities between the crimes?"

\tiny First of all, the median proportion of all break-ins that occur in each neighboorhood is a median of 0.0087. This information can be expanded on, and we observed that there is in fact a difference between the proportion of break-ins that occur in low-risk and high-risk neighboorhoods. 

\tiny Next, to answer our second research question, we analyzed the data for the specific dates and times at which the B&E's occured. From this, we are able to conclude that the trends in terms of the time of day, day of the week, and month of the year, vary between neighboorhoods of low risk, and those of high risk. 

\tiny With our data about which neighboorhoods break-ins occur in, we were able to summarise that a high 2 percent of break-ins occur in high-risk neighboorhoods. On the contrary, in low-risk neighboorhoods, this figure is lower than 0.5%.

\tiny Overall, the observed trends say something significant about the ocurrences of break-ins in Toronto. We observe that specific neighboorhoods are at a higher risk, and that break-ins occur at different rates in different neighboorhoods, whether it be a function of the time of day or of the year. 
